...
- 전화번호·주민등록번호 등 민감 개인정보를 수집하지 않습니다.
- 사용자 취향 데이터를 외부에 판매하거나 제3자와 공유하지 않습니다.
- 자동 결제·구매 기능이 없습니다.
- 서비스 API 키는 클라이언트에 노출되지 않습니다.

자세한 내용은 [docs/privacy-policy.md](./docs/privacy-policy.md)를 참고하세요.
